package com.liubomyr.opanovych.lightchat.core.users.add;
...
import com.liubomyr.opanovych.lightchat.utils.SharedPrefUtil;
...
public class AddUserInteractor implements AddUserContract.Interactor {
    ...
    public void addUserToDatabase(final Context context, FirebaseUser firebaseUser) {
        ...
        User user = new User(firebaseUser.getUid(),
                ...
                new SharedPrefUtil(context).getString(Constants.ARG_FIREBASE_TOKEN),firebaseUser.getDisplayName());
